...
> ⚠️ 这一处和我**最初定的引脚表**（「舵机 PWM = PA2 / TIM2_CH3」）不一致。
> **[README 的「引脚分配」](../README.md#引脚分配)一节记的是改过之后的结果**，原因写在这里：**PA2 是 TIM2_CH3，和呼吸灯的 TIM2_CH1 共用时基；想让舵机拿到精确的 50 Hz，就得把整个 TIM2 降到 50 Hz，呼吸灯会跟着变成 50 Hz 载波。** 所以我改用 TIM3_CH1 / PA6。
>
